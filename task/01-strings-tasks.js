...
function encodeToRot13(str) {
    var clear = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    var encode = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
    return str.split('').map((el) => clear.indexOf(el) > -1 ? encode[clear.indexOf(el)] : el ).join('')
}
